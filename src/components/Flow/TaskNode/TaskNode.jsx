...
function TaskNode({ data }) {
  ...
  const { handleDeleteTask } = useContext(FlowContext);
  ...
  const assingnUserName = useMemo(() => {
    if (
      value.assign_to == "team" ||
      value.assign_to == "freelancer" ||
      value.assign_to == "assign_to" ||
      value.assign_to == "client" ||
  ...
  return (
    <div
      className={cn("flex flex-col items-center justify-between border border-[#6DC3C8] rounded-lg shadow-sm bg-white w-96 p-2")}
    >
      <Handle type="target" position={Position.Top} className="w-2" />
      <div className="flex items-center justify-between gap-2 w-full pb-2 border-b-1 border-[#dedede]">
        {iconType}
        <span className="text-sm font-medium text-[#828187] mr-auto">{value?.title}</span>
        {/* <div
      ...
      <div className=" w-full p-4">
        <ul className="w-full flex flex-col gap-2">
          <li>
            <div className="flex items-start gap-1.5 text-[#4B5563] font-normal text-sm">
              <span className="text-sm font-normal text-[#4B5563] min-w-[100px]">Output :</span>
              <CustomTooltip content={value.output || "N/A"}>
                <strong className="font-medium text-[#4B5563] text-sm flex-1" style={twoLineClampStyle}>
                  {value.output || "N/A"}
                </strong>
              </CustomTooltip>
            </div>
          ...
          <li>
            <div className="flex items-start gap-1.5 text-[#4B5563] font-normal text-sm">
              <span className="text-sm font-normal text-[#4B5563] min-w-[100px]">Instruction :</span>
              <CustomTooltip content={value.instruction || "N/A"}>
                <strong className="font-medium text-[#4B5563] text-sm flex-1" style={twoLineClampStyle}>
          ...
          {assingnUserName && (
            <li>
              <a href="#" className="flex items-center gap-1.5 text-[#4B5563] font-normal text-sm">
                <div className="min-w-[100px] flex gap-2 items-center">
                  ...
                  <span className="text-sm font-normal text-[#4B5563]">Assign To :</span>
                </div>
                <strong className="font-medium text-[#4B5563] text-sm flex-1">{assingnUserName}</strong>
              </a>
            </li>
          )}
        </ul>
      ...
      <ConfirmDeleteModal
        ...
        setIsOpen={setTaskDeleteModal}
        onConfirm={() => handleDeleteTask(value.uuid)}
      />
      <TaskNodeOptionModal
