...
export const WorkflowPreviewPane = ({ data, onPrimaryAction, onClose, workflow }) => {
  ...
  return (
    <aside
      className="relative w-full max-h-svh flex flex-col border-l border-[#dbe5f4] bg-[linear-gradient(180deg,_#f8fbff_0%,_#f4f5fb_100%)] font-['Inter',_-apple-system,BlinkMacSystemFont,'Segoe_UI',sans-serif] text-[#1f2937]"
      role="complementary"
    >
      <div className="flex flex-col gap-5 overflow-y-auto h-20 grow p-6">
        <button
        type="button"
      ...
      <footer className="flex flex-col gap-4 text-[13px] text-[#475569] p-6 border-t border-solid border-gray-200">
